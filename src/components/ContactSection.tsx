  ...
  return (
    <section id="contact" className="py-20 relative z-10">
      <div className="max-w-4xl mx-auto px-6">
        <div className="backdrop-blur-md bg-white/5 rounded-2xl border border-[rgb(230,170,120)]/20 p-8 md:p-12 text-center">
          ...
          <div className="flex justify-center space-x-8 mb-12">
            {contacts.map(({ Icon, label, url }, index) => (
              ...
              >
                ...
                <div className="text-sm text-white/60 group-hover:text-white/80 transition-colors duration-300">{label}</div>
              </a>
            ))}
          </div>
          <a
